    ...
    <div className="min-h-screen">
      <header className="max-w-6xl mx-auto px-6 py-5 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="font-serif font-semibold text-xl tracking-tight">Bloom</span>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-6 items-center">
          <div className="lg:col-span-8 text-center lg:text-left order-2 lg:order-1">
            <div className="inline-flex items-center gap-1.5 chip mb-5 bg-brand-500/15 text-brand-700 dark:text-brand-300">
              <Leaf size={12} />
              Your daily habit garden
            </div>
            <h1 className="font-serif text-4xl md:text-6xl font-semibold tracking-tight leading-[1.1]">
              Habits that ,{" "}
              <br />
              {/* tended by an AI that{" "} */}
            ...
            <p className="mt-5 text-soft text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              Track what you do each day, build streaks that last, and let Bloom
              turn your patterns into real, personal insight — not generic push notifications.
            </p>
      ...
      <footer className="max-w-6xl mx-auto px-6 py-8 text-center text-xs text-faint border-t divider">
        Built with care · Bloom © {new Date().getFullYear()}
      </footer>
    </div>
  );
}
