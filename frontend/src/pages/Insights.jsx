    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="card p-6 relative overflow-hidden">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 0% 0%, rgba(74,124,89,0.15), transparent 55%), radial-gradient(circle at 100% 100%, rgba(194,123,108,0.1), transparent 55%)",
          }}
        />
            ...
            <ResponsiveContainer>
              <BarChart data={compareData}>
                ...
                <Legend
                  ...
                  iconSize={8}
                />
                <Bar dataKey="Last week" fill="#c8d6ca" radius={[4, 4, 0, 0]} />
                <Bar dataKey="This week" fill="#4a7c59" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
