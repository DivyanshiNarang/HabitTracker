  ...
  return (
    <div className="card p-5 relative overflow-hidden">
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 0% 0%, rgba(74,124,89,0.18), transparent 60%)",
        }}
      />
      <button
      ...
      >
        <div className="w-10 h-10 rounded-xl bg-linear-to-br from-brand-500 to-brand-700 text-white flex items-center justify-center shrink-0 shadow-lg shadow-brand-500/30">
          <Sparkles size={18} />
        </div>
