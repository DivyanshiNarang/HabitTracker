    ...
    <aside className="hidden md:flex md:flex-col w-64 fixed inset-y-0 left-0 z-30 glass border-r">
      <div className="px-6 py-5 border-b divider">
        <div className="flex items-center gap-2">
          ...
          <div className="font-serif font-semibold text-xl tracking-tight">Bloom</div>
        </div>
      </div>
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              `flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition ${isActive
                ? "nav-link-active text-brand-700 dark:text-brand-300"
      ...
      <div className="p-3 border-t divider space-y-1">
        ...
        <div className="px-2 py-2 flex items-center gap-3">
          <div className="w-9 h-9 rounded-full bg-linear-to-br from-brand-500 to-brand-700 text-white font-semibold flex items-center justify-center shadow-md shadow-brand-500/30">
